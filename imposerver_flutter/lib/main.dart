import 'package:imposerver_client/imposerver_client.dart';
import 'package:imposerver_flutter/loading_screen.dart';
import 'package:imposerver_flutter/note_dialog.dart';
...
class SignInPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Imposerver Sesion'),
      ),
      body: Center(
